...
//     {
//       image_url:
//         "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_mhj1shxHz8z1kZcD7EtUVu8NtPT_fwdzjA&usqp=CAU",
...
let dataMens= JSON.parse(localStorage.getItem("mens"))||[];
// localStorage.setItem("mens",JSON.stringify(mensData));
dataMens.forEach((elem,index)=>{
    ...
    div.append(img,h4,strikePrice,price,button);
    mainDiv.append(div);
})
