...
function App() {
  return (
    <div className="App">
      <div>
        <img style={{width:"500px"}} data-testid="image-tag" src="https://images.unsplash.com/photo-1615826932727-ed9f182ac67e?ixlib=rb 4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2942&q=80" />
      </div>
      <div>
        <button data-testid="show-list-button">Show List</button>
      </div>
